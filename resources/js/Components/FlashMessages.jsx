      ...
      {flash.success && visible && (
        <div className="flex items-center justify-between max-w-xs transition duration-300 p-2 bg-white border rounded-md shadow-lg space-x-4">
          <div className="flex items-center">
            ...
            <p className="ml-3 mr-2 text-xs font-medium text-gray-600">{flash.success}</p>
          </div>
          <span className="inline-flex items-center cursor-pointer" onClick={() => setVisible(false)}>
      ...
      {flash.info && visible && (
        <div className="flex items-center justify-between max-w-xs p-2 bg-white border rounded-md shadow-lg space-x-4">
          <div className="flex items-center">
            ...
            <p className="ml-3 mr-2 text-xs font-medium text-gray-600">{flash.info}</p>
          </div>
          <span className="inline-flex items-center cursor-pointer" onClick={() => setVisible(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
      ...
      {flash.warning && visible && (
        <div className="flex items-center justify-between max-w-xs p-2 bg-white border rounded-md shadow-lg space-x-4">
          <div className="flex items-center">
            ...
            <p className="ml-3 mr-2 text-xs font-medium text-gray-600">{flash.warning}</p>
          </div>
          <span className="inline-flex items-center cursor-pointer" onClick={() => setVisible(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
      ...
      {flash.error && visible && (
        <div className="flex items-center justify-between max-w-xs p-2 bg-white border rounded-md shadow-lg space-x-4">
          <div className="flex items-center">
            ...
            <p className="ml-3 mr-2 text-xs font-medium text-gray-600">{flash.error}</p>
          </div>
          <span className="inline-flex items-center cursor-pointer" onClick={() => setVisible(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
