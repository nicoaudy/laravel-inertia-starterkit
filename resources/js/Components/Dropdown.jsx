...
const DropdownLink = ({ href, method = 'post', as = 'a', children }) => {
  return (
    <Link
      ...
      method={method}
      as={as}
      className="block w-full px-4 py-2 text-left text-sm leading-5 text-white bg-red-400 hover:bg-red-500 focus:outline-none focus:bg-red-500 transition duration-150 ease-in-out"
    >
      {children}
    </Link>
  );
